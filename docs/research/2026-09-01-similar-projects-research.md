...
| - | --------------------------------- | --------------------------------------------------------------------------- | ------ | ---------------------- | -------------- | ---------- |
| 1 | AI\_NovelGenerator                | [YILING0013](https://github.com/YILING0013/AI_NovelGenerator)               | \~5955 | 2026-08                | Python         | AGPL-3.0   |
...
| 5 | AI\_Novel                         | [kele-tao](https://github.com/kele-tao/AI_Novel)                            | \~252  | 2026-07                | Python         | Apache-2.0 |

注：用户提及的 `huggingface/nanochat`、`CreativeAGI/WritingAssistant` 等经检索未验证为相关成熟项目，按"宁缺毋滥"原则剔除。

## 二、横向对比分析

| 维度             | AI\_NovelGenerator | SillyTavern | WriteHERE    | wfcz10086 | AI\_Novel |
| -------------- | ------------------ | ----------- | ------------ | --------- | --------- |
| 长文一致性记忆        | ★★★                | ★★          | ★★★          | ★★        | ★★        |
...
- **产品对标准绳：AI\_NovelGenerator**——验证「设定→大纲→目录→正文→审校→迭代」长篇小说流水线有效。注意 AGPL 传染风险，仅参考思想。

- **补充参考：SillyTavern / AI\_Novel**——多模型统一接入层与轻量数据结构。
...
| -------------------------------- | --------------------------------------------- | ---------------------------- |
| AI\_NovelGenerator（\~5.9k Star）  | 一键孕育百万字、世界观→分卷→目录→正文→审校迭代、**前文摘要 / 伏笔 / 一致性** | 与一至四节结论一致：长篇连续性才是核心差异点，本项目同向 |
...
- [AI\_NovelGenerator 头条安利（百万字小说工厂）](http://m.toutiao.com/group/7546391332651074098/)
