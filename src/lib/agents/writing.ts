...
文笔三板斧（每章必须遵守）：
一、【抽象变动作】情绪不直接下结论（禁止"他很愤怒/很紧张"式讲述）：先写身体与感官反应（手心出汗、呼吸一滞），再写情绪外露的动作神态，最后才写人物意识到什么
二、【环境碰人物】环境描写必须"碰到"人物——至少完成一件事：妨碍他、帮助他、暴露信息、或逼他做出选择；禁止与剧情无关的纯装饰性景物铺陈
三、【过场快对线慢】过场、赶路、日常交代一笔带过；冲突对线、情绪交锋、爽点兑现放慢写足——把字数花在读者最想看的地方`;
